...
class UserCreateSerializerTestCase(TestCase):
    ...
    def test_user_serializer_username_invalid(self):
        ...
        """
        self.assertEqual(serializer.errors["username"][0], "Username precisa de no minimo 4 caracteres")
    ...
    def test_user_serializer_username_invalid(self):
        ...
        self.assertFalse(serializer.is_valid())
        #import pdb ; pdb.set_trace()
        self.assertEqual(serializer.errors["email"][0], "O email não esta num formato valido")